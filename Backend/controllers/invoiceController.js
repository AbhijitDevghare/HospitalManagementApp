...
const getInvoiceByBookingId = asyncHandler(async (req, res, next) => {
  try {
...
const markInvoiceAsPaid = asyncHandler(async (req, res, next) => {
  try {
...
const previewInvoice = asyncHandler(async (req, res, next) => {
  try {
